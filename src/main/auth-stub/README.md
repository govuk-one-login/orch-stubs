...
- Generate a signed and encrypted JWT using `npm run createAuthRequestObject`. It should output something along the lines of `Here's your request object: <JWE>`
