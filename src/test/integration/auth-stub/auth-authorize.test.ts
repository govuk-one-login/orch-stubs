...
beforeEach(resetAuthCodeStoreTable);
...
describe("IPV Authorize", () => {
  ...
  it("should return 302 for valid POST request and update Dynamo", async () => {
    ...
    const actualAuthCodeStore = await getAuthCodeStore(AUTH_CODE);
    expect(actualAuthCodeStore).toMatchObject(expectedAuthCodeStore);
  });
